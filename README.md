...
Для того, чтобы воспользоваться скриптом, установите Perl не ниже версии 5.18, модули Tk и Config::General, а также скачайте этот проект.
...
Вкладка «Мод сохранения» предназначена для исправления ошибок работы CK2 DLC—экспортёра сохранения в виде мода для EU4 при работе в русифицированной версии Windows. Конвертирование производится в рамках кодировки, мод-локализацию которой вы использовали в CK2 в соответствующую в EU4. Перекодировку рекомендуется производить на копии мода-сохранения, т. к. обрабатываемые файлы будут изменены.
...
Этот текст доступен на условиях лицензии CC-BY-NC-ND 4.0 Международная (https://creativecommons.org/licenses/by-nc-nd/4.0/). Программный код скрипта доступен на условиях GPLv3 или более поздней версии.
