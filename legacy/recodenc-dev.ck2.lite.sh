...
loc_eng="$1" # каталог с файлами «*.csv», в которых во втором поле содержится английская локализация
loc_rus="$2" # каталог с файлами «*.csv», в которых во втором поле содержится русская локализация
loc="$3" # каталог с результирующей локализацией
